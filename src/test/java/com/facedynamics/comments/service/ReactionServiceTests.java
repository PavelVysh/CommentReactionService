...
public class ReactionServiceTests {
    ...
    void findReactionTestSuccessfulTest() {
        ...
        Page<ReactionReturnDTO> response = reactionsService.findByEntity(2, EntityType.post,
                PageRequest.of(0, 10));

        assertEquals("finding reactions for entity", 2L, response.getTotalElements());

        verify(reactionsRepository, times(1))
                .findAllByEntityIdAndEntityType(2, EntityType.post,  PageRequest.of(0, 10));
    }
    ...
    void findReactionTestNotFoundTest() {
        ...
        assertThrows(NotFoundException.class, () ->
                        reactionsService.findByEntity(2, EntityType.post,  PageRequest.of(0, 10)),
                "Should throw NotFoundException");

        verify(reactionsRepository, times(1)).findAllByEntityIdAndEntityType(
                anyInt(), any(), any());
    }
    ...
    void findByUserIdAndTypeSuccessfulTest() {
        ...
        Page<ReactionReturnDTO> response = reactionsService.findByUser(1, EntityType.post,  PageRequest.of(0, 10));

        assertEquals("Finding reactions successfully", 2L, response.getTotalElements());

        verify(reactionsRepository, times(1)).findAllByUserIdAndEntityType(
                anyInt(), any(), any());
    }
    ...
    void findByUserIdAndTypeFailTest() {
        ...
        assertThrows(NotFoundException.class, () ->
                        reactionsService.findByUser(1, EntityType.post,  PageRequest.of(0, 10)),
                "Should throw NotFoundException");

        verify(reactionsRepository, times(1)).findAllByUserIdAndEntityType(anyInt(), any(), any());
    }
