TRUNCATE TABLE commentsreactions.comments RESTART IDENTITY;
TRUNCATE TABLE commentsreactions.reactions RESTART IDENTITY;
INSERT INTO commentsreactions.comments(post_id, user_id, text)
...
INSERT INTO commentsreactions.reactions(user_id, entity_id, entity_type, is_like)
